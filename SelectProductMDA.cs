...
public class SelectProductMDA
{
    ...
    public void SelecionarProdutoMDA()
    {
      ...
      // Valida o icone do carrinho
        string iconeProduto = driver.FindElement(MobileBy.Id("com.saucelabs.mydemoapp.android:id/cartTV")).Text;
        Assert.That(iconeProduto, Is.EqualTo("1"));
